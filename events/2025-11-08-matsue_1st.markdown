...
mrubyのお話
    ...
    <div class="information">
      ...
      <p>
        <a href="htps://www.carrot.co.jp/" style="float:right; margin:0 0 0 15px; border:0; "><img src="/images/matsue1st/KCSC.png" alt="株式会社ケーシーエスキャロット" width="200"></a>
        <a href="https://www.carrot.co.jp/">株式会社ケーシーエスキャロット</a>は、「Create(創造)・Cooperate(協力)・Coordinate(調和)・Collaborate(共争)」を経営ビジョンとして、デジタル放送機器、音楽・ニュースの配信分野、AV機器の組込みソフトや、Webアプリケーション開発などを取り組んでおります。
      </p>
  ...
  <div class="team">
    ...
    <a href="https://x.com/yhara" class="coach">
      <img src="https://avatars.githubusercontent.com/u/12285?v=4">
      Yutaka Hara
      <br/>
      coach
      <small>@yhara</small>
